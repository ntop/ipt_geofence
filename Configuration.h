...
class Configuration {
 ...
 public:
  ...
  inline void saveInStorage()                                                                     { blacklists.save(); }
  inline void loadFromStorage(std::unordered_map<std::string, WatchMatches*>& watches_blacklist)  { blacklists.load(watches_blacklist); }
